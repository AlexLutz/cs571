...
public class DEPFeatureTemplate1 extends DEPFeatureTemplate {
    ...
    protected void init() {
        ...
        //distance features
//        add(new FeatureItem<>(Source.i, null, 0, Field.distance, true));  ADD
...
//        add(new FeatureItem<>(Source.i,  0, Field.lemma),
//                new FeatureItem<>(Source.i, Field.subcategory_pos, Direction.right)); ADD
//        add(new FeatureItem<>(Source.i,  0, Field.pos_tag),
//                new FeatureItem<>(Source.i, Field.subcategory_pos, Direction.right));
//        add(new FeatureItem<>(Source.i,  0, Field.lemma),
//                new FeatureItem<>(Source.i, Field.subcategory_pos, Direction.left));
//        add(new FeatureItem<>(Source.i,  0, Field.pos_tag),
//                new FeatureItem<>(Source.i, Field.subcategory_pos, Direction.left));
//        add(new FeatureItem<>(Source.j,  0, Field.lemma),
//                new FeatureItem<>(Source.j, Field.subcategory_pos, Direction.left));
//        add(new FeatureItem<>(Source.j,  0, Field.pos_tag),
//                new FeatureItem<>(Source.j, Field.subcategory_pos, Direction.left));
        //S0wd;S0pd;N0wd;N0pd;
        add(new FeatureItem<>(Source.i,  0, Field.lemma), new FeatureItem<>(Source.i, 0, Field.path));
        add(new FeatureItem<>(Source.i,  0, Field.pos_tag), new FeatureItem<>(Source.i, 0,Field.path));
        add(new FeatureItem<>(Source.j,  0, Field.lemma), new FeatureItem<>(Source.i, 0, Field.path));
        add(new FeatureItem<>(Source.j,  0, Field.pos_tag), new FeatureItem<>(Source.i, 0, Field.path));
...
//                new FeatureItem<>(Source.j, 0, Field.pos_tag));
        ...
        //try norm
//        add(new FeatureItem<>(Source.i, 0, Field.norm));  ADD
